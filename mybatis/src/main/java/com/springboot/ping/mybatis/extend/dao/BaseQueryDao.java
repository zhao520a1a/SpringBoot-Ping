...
public interface BaseQueryDao<T extends BaseModel> extends SqlMapper{
     ...
     * @return 无记录则返回0
     */
    public long count(@Param(value = "conditions") List<Condition> conditions);
    /**
     * 按条件查询某些字段的去重总记录数
     ...
     * @return 无记录则返回0
     */
    public long countDistinctColumns(@Param(value = "columns") String columns,@Param(value = "conditions") List<Condition> conditions);
    /**
     * 按条件查询某个字段的求和总计
     ...
     * @return
     */
    public BigDecimal sumColumn(@Param(value = "column") String column,@Param(value = "conditions") List<Condition> conditions);
    /**
     * 按条件查询某个字段的最大值
     ...
     * @return
     */
    public BigDecimal maxColumn(@Param(value = "column") String column, @Param(value = "conditions") List<Condition> conditions);
    /**
     * 按条件查询某个字段的最小值
     * @param column 要最大值的字段名称
     * @param conditions
     * @return
     */
    public BigDecimal minColumn(@Param(value = "column") String column,@Param(value = "conditions") List<Condition> conditions);
    /**
     * 按条件查询某个字段的平均值
     ...
     * @return
     */
    public BigDecimal avgColumn(@Param(value = "column") String column,@Param(value = "conditions") List<Condition> conditions);
