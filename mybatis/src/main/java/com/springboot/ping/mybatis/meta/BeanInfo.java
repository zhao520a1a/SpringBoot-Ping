...
import com.springboot.ping.common.util.ClassUtils;
import com.springboot.ping.common.util.StringUtil;
import com.springboot.ping.mybatis.annotation.*;
    ...
    private <T> List<PropertyInfo> getPropertyInfos(Class<T> clazz){
        ...
        for(Field field : fields){
            ...
            if(!readMethod.isAnnotationPresent(Transient.class) && !isCollectionType(readMethod)){
                ...
                com.springboot.ping.mybatis.annotation.Column column = field.getAnnotation(com.springboot.ping.mybatis.annotation.Column.class);
                if(column!=null){
                ...
                if(pk!=null){
                    ...
                    if(sequence!=null){
                        ...
                        if(StringUtil.isNotEmpty(seq_name)){
