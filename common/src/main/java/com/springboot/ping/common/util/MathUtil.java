...
public class MathUtil {
	...
	public static double divide(String dividend,String divisor){
		try {
			...
			BigDecimal dividendBD = new BigDecimal((StringUtil.isNotEmpty(dividend))?dividend.trim():"0");
			BigDecimal divisorBD = new BigDecimal((StringUtil.isNotEmpty(divisor))?divisor.trim():"1");
